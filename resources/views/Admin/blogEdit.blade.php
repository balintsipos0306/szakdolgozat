  ...
  <div class="container">
    <form action="/blog-update" method="POST" enctype="multipart/form-data">
      ...
      <div class="mb-3">
        ...
        <input type="text" class="form-control" id="id" name="id" value="{{$blog->id}}" readonly>
      </div>
      <div class="mb-3">
      ...
      <div class="mb-3">
      <img id="boritokep" src="{{asset('storage/' . $blog->image_path )}}">
      </div>
      <div class="mb-3">
